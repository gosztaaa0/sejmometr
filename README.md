...
1. Sklonuj repozytorium:
   ```bash
   git clone [[https://github.com/TWOJA_NAZWA_UZYTKOWNIKA/Sejmometr.git](https://github.com/TWOJA_NAZWA_UZYTKOWNIKA/Sejmometr.git)](https://github.com/gosztaaa0/sejmometr.git)
